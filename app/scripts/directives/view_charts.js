  ...
  .directive('viewCharts', function () {
    return {
      ...
      link: function postLink(scope, element, attrs) {
      	...
      	scope.tabs = [{label:'Facesheet',value:'facesheet'},{label:'Timeline',value:'timeline'},{label:'Office Visit',value:'visit'}];
      	...
      	scope.charts = [
	        ...
	        },
	        {
	          ...
	          dob: '1980-04-11T00:00:00+00:00',
	          age:'33',
	          sex:'Male',
	          phone:'4151234567',
	          insurance:'Obama Care',
	          facesheet:{},
	          timeline:{},
	          visit:{
	          	cc: 'Flu',
	    ...
	    scope.patientLabel = function(first,last) {
	    	return first + ' ' + last;
	    }
